...
namespace HostsWizard
{
    public partial class frmMainR : Form
    {
        ...
        private void HostWizardsMain_Load(object sender, EventArgs e)
        {
            ...
            //(new LanguageUtility()).SetLanguage(this.menuStrip1);
        ...
        private void UpdateGoogleHosts()
        {
            try
            {
            ...
            {
                MessageBox.Show("获取hosts列表失败!请稍后重试!或确认网络是否正常.");
            }
        }

        private void btnsAddItem_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (host == null)
            {
                MessageBox.Show("未加载任何Hosts信息!");
        ...
        private void btnsAddItems_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            //批量添加
            if (host == null)
            {
        ...
        private void btnsAddGroup_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (host == null)
            {
                MessageBox.Show("未加载任何Hosts信息!");
        ...
        private void btnsFlushDns_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            RefreshDNS();
        }

        private void btnsSaveApply_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            SaveAndApply();
        }

        private void btnsUpdateGoogle_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            UpdateGoogleHosts();
