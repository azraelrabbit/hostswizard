...
namespace HWUtility.Utilit
{
    public class Constants
    {
        ...
        public static readonly string ApplicationName = "HWUtilitys";

        public static readonly string HostsPath = (Environment.SystemDirectory + @"\drivers\etc\Hosts");

        public static readonly string HostsBackUpPath = AppDataLocalPath + @"\HWUtilitys\Backup";

        public static readonly string ApplicationStartUpPath = AppDomain.CurrentDomain.BaseDirectory;

        public static readonly string ApplicationFilePath = AppDomain.CurrentDomain.BaseDirectory;

        public static readonly string DefaultAppDataFilePath = ApplicationStartUpPath + @"\hsw.db";

        public static readonly string HWUtilitysDataPath = AppDataLocalPath + @"\HWUtilitys\Data";

        public static readonly string HWUtilitysDataFilePath = HWUtilitysDataPath + @"\hsw.db";

        public static int StatusBarClearInterval = 8000;

        public static string SqliteDBConfig = "Data Source=" + HWUtilitysDataFilePath + ";Pooling=true;FailIfMissing=false";
